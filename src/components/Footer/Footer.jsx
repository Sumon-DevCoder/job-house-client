          ...
          <div className="sm:col-span-2">
            ...
            <div className="mt-6 lg:max-w-xl">
              <p className="text-sm text-gray-800 dark:text-gray-200">
                ...
                Freshersworld is the best website for freshers who just
                completed their education and looking for a job. As a top online
                job portal, we act as a medium to connect freshers with
                recruiters and employers and help them to find their suitable
                jobs according to their profession and educational
                qualification.
              </p>
            </div>
          </div>
